...
* **תיאור:** יוצר משתמש חדש, מקצה לו אוטומטית 100 מטבעות התחלתיים ויוצר קוד הפניה ייחודי (6 תווים). במידה והוזן קוד הפניה של חבר, המפנה מקבל מיידית בונוס של 50 מטבעות לארנק שלו!
* **Body לדוגמה:**
```json
{
  "name": "דוד כהן",
...
* **תיאור:** התחברות קלה באמצעות שם / כינוי / קוד הפניה / מזהה + קוד PIN בן 4 ספרות.
* **Body לדוגמה:**
```json
{
  "identifier": "davidc",
